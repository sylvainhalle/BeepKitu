...
//import ca.uqam.info.logic.Operator;
//import ca.uqam.info.runtime.RuntimeMonitor;
...
public class BulletBill extends Sprite
{
    ...
    {
    	//runtime.setFormula("G ([m1 /a/b] != ({collideCheck}) )");
        sheet = Art.enemies;
    ...
    {
    	//runtime.update("<a><b>collideCheck</b></a>");
    	//runtime.getOutcome();
        if (dead) return;
